...
public class MakeSemanticNet{
	...
	//飛世裕貴のセマンティックネット
		sn.addLink(new Link("is-a","飛世裕貴","名工大生",sn));
		...
		sn.addLink(new Link("is-a","名工大生","大学生",sn));
		sn.addLink(new Link("しない","大学生","勉強",sn));
		sn.addLink(new Link("is-a","ランボルギーニ","自動車",sn));
		sn.addLink(new Link("is-a","ビール","酒",sn));
		sn.addLink(new Link("is-a","日本酒","酒",sn));
		sn.addLink(new Link("is-a","サッカー","スポーツ",sn));
		sn.addLink(new Link("is-a","バスケ","スポーツ",sn));
		sn.addLink(new Link("has-a","日本","三重県",sn));
		sn.addLink(new Link("has-a","日本","愛知県",sn));

	//池口弘尚のセマンティックネット
		sn.addLink(new Link("is-a","池口","名工大の学生",sn));
		...
		sn.addLink(new Link("is-a","Nintendo Switch","電子機器",sn));
		sn.addLink(new Link("is-a","Alienware17 R4","ノートパソコン",sn));
		sn.addLink(new Link("製造","Alienware","Alienware17 R4",sn));
		sn.addLink(new Link("is-a","ノートパソコン","電子機器",sn));
		sn.addLink(new Link("has-a","電子機器","Processing Unit",sn));

	//大原拓人のセマンティックネット
		sn.addLink(new Link("is-a","大原拓人","長距離ランナー",sn));
		...
		sn.addLink(new Link("is-a","長距離ランナー","陸上部員",sn));
		sn.addLink(new Link("is-a","冴えカノ","アニメ",sn));
		sn.addLink(new Link("is-a","ブラクロ","アニメ",sn));
		sn.addLink(new Link("has-a","日本","富山",sn));
		sn.addLink(new Link("is-a","モンハン","ゲーム",sn));
		sn.addLink(new Link("is-a","ロードバイク","自転車",sn));
		sn.addLink(new Link("is-a","VSCode","エディタ",sn));
		sn.addLink(new Link("is-a","米津玄師","アーティスト",sn));
		sn.addLink(new Link("is-a","Xperia","スマホ",sn));
		sn.addLink(new Link("is-a","iPhone","スマホ",sn));

	//野竹浩二朗のセマンティックネット
		sn.addLink(new Link("is-a","野竹浩二朗","名工大生",sn));
		...
		sn.addLink(new Link("is-a","Splatoon","ゲーム",sn));
		sn.addLink(new Link("has-a","歌","合唱",sn));
		sn.addLink(new Link("has-a","スマホ","iPhone",sn));
		sn.addLink(new Link("材料","唐揚げ","鶏肉",sn));
		sn.addLink(new Link("原料","鶏肉","鶏",sn));
		sn.addLink(new Link("is-a","日本","国",sn));
